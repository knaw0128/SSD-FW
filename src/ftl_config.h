...
#ifdef	XPAR_SYS_TOP_I_T4NFC_HLPER_7_BASEADDR
#define NSC_7_CONNECTED	1
#define NSC_7_UCODEADDR XPAR_SYS_TOP_I_AXI_BRAM_CTRL_7_S_AXI_BASEADDR
#define NSC_7_BASEADDR	XPAR_SYS_TOP_I_T4NFC_HLPER_7_BASEADDR
#else
#define NSC_7_CONNECTED	0
#define NSC_7_UCODEADDR 0
#define NSC_7_BASEADDR	0
#endif
#ifdef	XPAR_SYS_TOP_I_T4NFC_HLPER_6_BASEADDR
#define NSC_6_CONNECTED	1
#define NSC_6_UCODEADDR XPAR_SYS_TOP_I_AXI_BRAM_CTRL_6_S_AXI_BASEADDR
#define NSC_6_BASEADDR	XPAR_SYS_TOP_I_T4NFC_HLPER_6_BASEADDR
#else
#define NSC_6_CONNECTED	0
#define NSC_6_UCODEADDR 0
#define NSC_6_BASEADDR	0
#endif
#ifdef	XPAR_SYS_TOP_I_T4NFC_HLPER_5_BASEADDR
#define NSC_5_CONNECTED	1
#define NSC_5_UCODEADDR XPAR_SYS_TOP_I_AXI_BRAM_CTRL_5_S_AXI_BASEADDR
#define NSC_5_BASEADDR	XPAR_SYS_TOP_I_T4NFC_HLPER_5_BASEADDR
#else
#define NSC_5_CONNECTED	0
#define NSC_5_UCODEADDR 0
#define NSC_5_BASEADDR	0
#endif
#ifdef	XPAR_SYS_TOP_I_T4NFC_HLPER_4_BASEADDR
#define NSC_4_CONNECTED	1
#define NSC_4_UCODEADDR XPAR_SYS_TOP_I_AXI_BRAM_CTRL_4_S_AXI_BASEADDR
#define NSC_4_BASEADDR	XPAR_SYS_TOP_I_T4NFC_HLPER_4_BASEADDR
#else
#define NSC_4_CONNECTED	0
#define NSC_4_UCODEADDR 0
#define NSC_4_BASEADDR	0
#endif
#ifdef	XPAR_SYS_TOP_I_T4NFC_HLPER_3_BASEADDR
#define NSC_3_CONNECTED	1
#define NSC_3_UCODEADDR XPAR_SYS_TOP_I_AXI_BRAM_CTRL_3_S_AXI_BASEADDR
#define NSC_3_BASEADDR	XPAR_SYS_TOP_I_T4NFC_HLPER_3_BASEADDR
#else
#define NSC_3_CONNECTED	0
#define NSC_3_UCODEADDR 0
#define NSC_3_BASEADDR	0
#endif
#ifdef	XPAR_SYS_TOP_I_T4NFC_HLPER_2_BASEADDR
#define NSC_2_CONNECTED	1
#define NSC_2_UCODEADDR XPAR_SYS_TOP_I_AXI_BRAM_CTRL_2_S_AXI_BASEADDR
#define NSC_2_BASEADDR	XPAR_SYS_TOP_I_T4NFC_HLPER_2_BASEADDR
#else
#define NSC_2_CONNECTED	0
#define NSC_2_UCODEADDR 0
#define NSC_2_BASEADDR	0
#endif
#ifdef	XPAR_SYS_TOP_I_T4NFC_HLPER_1_BASEADDR
#define NSC_1_CONNECTED	1
#define NSC_1_UCODEADDR XPAR_SYS_TOP_I_AXI_BRAM_CTRL_1_S_AXI_BASEADDR
#define NSC_1_BASEADDR	XPAR_SYS_TOP_I_T4NFC_HLPER_1_BASEADDR
#else
#define NSC_1_CONNECTED	0
#define NSC_1_UCODEADDR 0
#define NSC_1_BASEADDR	0
#endif
#ifdef	XPAR_SYS_TOP_I_T4NFC_HLPER_0_BASEADDR
#define NSC_0_CONNECTED	1
#define NSC_0_UCODEADDR XPAR_SYS_TOP_I_AXI_BRAM_CTRL_0_S_AXI_BASEADDR
#define NSC_0_BASEADDR	XPAR_SYS_TOP_I_T4NFC_HLPER_0_BASEADDR
#else
...
#define NUMBER_OF_CONNECTED_CHANNEL (1)
